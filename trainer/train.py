...
def parse_args():
    ...
    parser.add_argument('--shuffle_buffer_size', default=64, help='Learning rate.', type=int)
...
def run_experiment(args):
    ...
    num_train_samples = sum(1 for f in file_io.get_matching_files(args.train_files)
                            for _ in tf.python_io.tf_record_iterator(f))

    print("Number of training content samples: " + str(num_train_samples))
    ...
    train_inputs_fn = create_inputs_fn(
        content_tfrecords=args.train_files,
